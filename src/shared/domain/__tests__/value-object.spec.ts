...
describe('ValueObject Unit Tests', () => {
  test('should be equals', () => {
    ...
    const complexValueObject1 = new ComplexValueObject('prop', 1);
    const complexValueObject2 = new ComplexValueObject('prop', 1);
  ...
  test('should not be equals', () => {
    ...
    const complexValueObject1 = new ComplexValueObject('prop', 1);
    const complexValueObject2 = new ComplexValueObject('prop', 2);
